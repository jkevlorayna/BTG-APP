...
<head>
	...
	<title>Nergos Island Travel Guide Guide Administrator</title>
	<!-- Bootstrap core CSS -->
	...
	<link href="<?php echo $path; ?>css/skin-green.css" rel="stylesheet" />	
	<link href="<?php echo $path; ?>css/custom.css" rel="stylesheet" />
	<link href="<?php echo $path; ?>css/angular-input-stars.css" rel="stylesheet" />
